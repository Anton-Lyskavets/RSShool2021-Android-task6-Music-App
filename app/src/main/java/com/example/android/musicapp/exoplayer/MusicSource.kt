...
import com.example.android.musicapp.exoplayer.State.STATE_CREATED
import com.example.android.musicapp.exoplayer.State.STATE_ERROR
import com.example.android.musicapp.exoplayer.State.STATE_INITIALIZED
import com.example.android.musicapp.exoplayer.State.STATE_INITIALIZING
import com.example.android.musicapp.other.Parser
...
class MusicSource @Inject constructor(
    ...
    suspend fun fetchMediaData() = withContext(Dispatchers.Main) {
        ...
        val allSongs = parser.getPlaylist()
